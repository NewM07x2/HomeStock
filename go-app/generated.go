...
type ComplexityRoot struct {
	Mutation struct {
		CreateItem func(childComplexity int, name string) int
	}
...
type MutationResolver interface {
	CreateItem(ctx context.Context, name string) (string, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createItem":
		...
		return e.complexity.Mutation.CreateItem(childComplexity, args["name"].(string)), true
...
func (ec *executionContext) _Mutation_createItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			...
			return ec.resolvers.Mutation().CreateItem(ctx, fc.Args["name"].(string))
		},
		nil,
