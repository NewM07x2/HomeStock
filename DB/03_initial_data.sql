...
-- ユーザー（email: admin@homestock.local, password: admin123）
...
SELECT 'HSM-0001', 'ねじM5', 
    (SELECT id FROM categories WHERE code = 'HARDWARE'),
    (SELECT id FROM units WHERE code = 'pc'), 120, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0001');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0002', 'ナットM5',
    (SELECT id FROM categories WHERE code = 'HARDWARE'),
    (SELECT id FROM units WHERE code = 'pc'), 240, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0002');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0003', 'ワッシャーM5',
    (SELECT id FROM categories WHERE code = 'HARDWARE'),
    (SELECT id FROM units WHERE code = 'pc'), 60, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0003');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0004', 'ボルトM8',
    (SELECT id FROM categories WHERE code = 'HARDWARE'),
    (SELECT id FROM units WHERE code = 'pc'), 85, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0004');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0005', '木ネジ',
    (SELECT id FROM categories WHERE code = 'HARDWARE'),
    (SELECT id FROM units WHERE code = 'pc'), 150, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0005');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0006', 'L字金具',
    (SELECT id FROM categories WHERE code = 'HARDWARE'),
    (SELECT id FROM units WHERE code = 'pc'), 45, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0006');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0007', '接着剤',
    (SELECT id FROM categories WHERE code = 'CONSUMABLE'),
    (SELECT id FROM units WHERE code = 'ml'), 500, 'active'
WHERE NOT EXISTS (SELECT 1 FROM items WHERE code = 'HSM-0007');

INSERT INTO items (code, name, category_id, unit_id, quantity, status)
SELECT 'HSM-0008', 'サンドペーパー',
    (SELECT id FROM categories WHERE code = 'CONSUMABLE'),
    (SELECT id FROM units WHERE code = 'sheet'), NULL, 'active'
...
SELECT 
    ...
    (SELECT id FROM attributes WHERE code = 'brand'), 'ABC'
WHERE NOT EXISTS (
...
SELECT 
    (SELECT id FROM items WHERE code = 'HSM-0001'),
    (SELECT id FROM attributes WHERE code = 'spec'), 'M5x12'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
    WHERE item_id = (SELECT id FROM items WHERE code = 'HSM-0001')
...
SELECT 
    (SELECT id FROM items WHERE code = 'HSM-0002'),
    (SELECT id FROM attributes WHERE code = 'spec'), 'M5'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
    WHERE item_id = (SELECT id FROM items WHERE code = 'HSM-0002')
    AND attribute_id = (SELECT id FROM attributes WHERE code = 'spec'));
...
SELECT 
    ...
    (SELECT id FROM attributes WHERE code = 'brand'), 'XYZ'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
...
SELECT 
    (SELECT id FROM items WHERE code = 'HSM-0004'),
    (SELECT id FROM attributes WHERE code = 'spec'), 'M8x20'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
    WHERE item_id = (SELECT id FROM items WHERE code = 'HSM-0004')
    AND attribute_id = (SELECT id FROM attributes WHERE code = 'spec'));
...
SELECT 
    ...
    (SELECT id FROM attributes WHERE code = 'brand'), 'DEF'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
...
SELECT 
    (SELECT id FROM items WHERE code = 'HSM-0005'),
    (SELECT id FROM attributes WHERE code = 'spec'), '4x30'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
    WHERE item_id = (SELECT id FROM items WHERE code = 'HSM-0005')
    AND attribute_id = (SELECT id FROM attributes WHERE code = 'spec'));
...
SELECT 
    ...
    (SELECT id FROM attributes WHERE code = 'size'), '50mm'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
...
SELECT 
    ...
    (SELECT id FROM attributes WHERE code = 'type'), '瞬間接着剤'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
...
SELECT 
    ...
    (SELECT id FROM attributes WHERE code = 'grit'), '#240'
WHERE NOT EXISTS (
    SELECT 1 FROM item_attributes 
...
UPDATE items SET unit_price = 200 WHERE code = 'HSM-0005';
UPDATE items SET unit_price = 1500 WHERE code = 'HSM-0006';
UPDATE items SET unit_price = 300 WHERE code = 'HSM-0007';
UPDATE items SET unit_price = 800 WHERE code = 'HSM-0008';
